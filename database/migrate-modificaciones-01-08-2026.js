/**
 * Migración: aplica database/modificaciones01-08-2026.sql
 *  - Nuevo rol 'invitado' en profiles
 *  - Tabla guests (huéspedes no alumnos)
 *  - Tabla cleaning_sessions (cronómetro de limpieza)
 *  - Contrato de huéspedes + guest_id en documents
 *  - Cursos y student_cursos
 *
 * Es idempotente: si una sentencia ya está aplicada, la omite y continúa.
 * Ejecutar: node database/migrate-modificaciones-01-08-2026.js
 */
...
async function migrate() {
  ...
  const sql = fs.readFileSync(path.join(__dirname, 'modificaciones01-08-2026.sql'), 'utf8');
  ...
  console.log('\nMigración 01-08-2026 aplicada correctamente.');
  await db.end();
}
