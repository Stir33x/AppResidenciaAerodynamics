/**
 * Migración: aplica database/modificaciones06-09-2026.sql
 *  - menu_orders: pedidos/encargos de platos del menú (quién encarga,
 *    qué plato, para qué día y en qué cantidad)
 *  - chat_messages: chat alumno ↔ dirección/administración
 *
 * Es idempotente: si una sentencia ya está aplicada, la omite y continúa.
 * Ejecutar: node database/migrate-modificaciones-06-09-2026.js
 */
...
async function migrate() {
  ...
  const sql = fs.readFileSync(path.join(__dirname, 'modificaciones06-09-2026.sql'), 'utf8');
  ...
  console.log('\nMigración 06-09-2026 aplicada correctamente.');
  await db.end();
}
