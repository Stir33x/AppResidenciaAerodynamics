/**
 * Migración: aplica database/modificaciones17-09-2026.sql
 *  - students.flightlogger_id: ID del alumno en FlightLogger (escuela de
 *    vuelo). Se guarda automáticamente al vincular desde el alta o desde
 *    la lista de alumnos.
 *
 * Es idempotente: si una sentencia ya está aplicada, la omite y continúa.
 * Ejecutar: node database/migrate-modificaciones-17-09-2026.js
 */
...
async function migrate() {
  ...
  const sql = fs.readFileSync(path.join(__dirname, 'modificaciones17-09-2026.sql'), 'utf8');
  ...
  console.log('\nMigración 17-09-2026 aplicada correctamente.');
  await db.end();
}
