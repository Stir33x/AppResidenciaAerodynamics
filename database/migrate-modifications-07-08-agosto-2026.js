/**
 * Migración unificada de agosto 2026.
 * Aplica en orden:
 *   1) database/modificaciones07-08-2026.sql
 ...
 *   2) database/modificaciones08-08-2026.sql
 ...
 * Ejecutar: node database/migrate-modifications-07-08-agosto-2026.js
 */
...
const MIGRATIONS = [
  { file: 'modificaciones07-08-2026.sql', name: '07-08-2026' },
  { file: 'modificaciones08-08-2026.sql', name: '08-08-2026' },
];

function loadStatements(sqlFile) {
...
async function migrate() {
  ...
  for (const mig of MIGRATIONS) {
    const statements = loadStatements(mig.file);
    console.log(`\n[${mig.name}] ${statements.length} sentencias sobre '${db.config.database}'...`);
  ...
  console.log('\nMigración de agosto 2026 aplicada correctamente.');
  await db.end();
}
