...
const menuItems = [
  ...
  { to: '/pedidos', labelKey: 'layout.orders', roles: ['estudiante', 'invitado', 'cocina', 'direccion'], icon: 'M11 9l3 3-3 3m5-6l3 3-3 3M5 4h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2zm4 0v20m8-16h.01M17 12h.01M17 16h.01' },
  { to: '/chat', labelKey: 'layout.chat', roles: ['estudiante', 'invitado', 'staff', 'cocina', 'limpieza', 'direccion', 'administracion'], icon: 'M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
  ...
  { to: '/limpieza-dashboard', labelKey: 'layout.cleaning_dashboard', roles: ['direccion', 'administracion'], icon: 'M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z' },
  ...
  { to: '/habitaciones', labelKey: 'layout.rooms', roles: ['direccion', 'administracion'], icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
    ...
    <div className="min-h-svh flex flex-col lg:flex-row">
      ...
      <div className="navbar bg-primary text-primary-content shadow-md lg:hidden sticky top-0 z-30">
        ...
        <div className="flex-1 flex items-center gap-2">
          <img src="/icon.png" alt="Aerodynamics" className="h-7 w-auto object-contain" />
      ...
      >
        ...
        <div className="flex items-center gap-3 p-5 border-b border-base-300">
          <img src="/icon.png" alt="Aerodynamics" className="h-12 w-auto shrink-0 object-contain" />
              ...
              return (
                <li key={to} className="min-w-0">
                  ...
                  >
                    ...
                    {to === '/chat' && noLeidas > 0 && (
                      <span className="badge badge-error badge-sm ml-auto min-w-5 px-1.5">{noLeidas > 99 ? '99+' : noLeidas}</span>
                    )}
                  </Link>
                </li>
              )
