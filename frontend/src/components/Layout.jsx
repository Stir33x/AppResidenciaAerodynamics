...
const menuItems = [
  ...
  { to: '/pedidos', labelKey: 'layout.orders', roles: ['estudiante', 'cocina', 'direccion'], icon: 'M11 9l3 3-3 3m5-6l3 3-3 3M5 4h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2zm4 0v20m8-16h.01M17 12h.01M17 16h.01' },
